<template>
  ...
  <div>
    <div class="mx-auto max-w-2xl text-center">
      <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Your
        <span class="relative whitespace-nowrap text-red-600">
          <svg aria-hidden="true" viewBox="0 0 418 42"
               class="absolute left-0 top-2/3 h-[0.58em] w-full fill-secondary/70 -z-10"
          ...
          <span class="relative -z-1">Free Go-To Minimal</span></span>
    ...
    <div class="relative">
      <NuxtImg src="/img/color-snap-demo-mac.png" alt="App screenshot" class="mt-16 rounded-md mx-auto sm:mt-24"
               loading="lazy"/>

    </div>

    <!--          <img src="/img/color-snap-demo-mac.png" alt="App screenshot"-->
    <!--               width="2432" height="1442" class="mt-16 rounded-md  sm:mt-24"/>-->
